...
import com.videoeditorsdk.android.app.custom.VideoPlayerActivity
...
class KVideoEditorDemoActivity : Activity(), PermissionRequest.Response {
    ...
    private fun openEditorVideoPlayer(inputSource: Uri?) {
        val settingsList = createVESDKSettingsList()
            .configure<LoadSettings> {
                it.source = inputSource
            }

        EditorBuilder(this, VideoPlayerActivity::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, intent: Intent?) {
        ...
        if (resultCode == RESULT_OK && requestCode == CAMERA_AND_GALLERY_RESULT) {
            ...
            if (selectedVideo != null) {
                openEditorVideoPlayer(selectedVideo)
            }
